...
import hr.fer.zemris.ecf.lab.view.fer.zemris.ecf.engine.log.Deme;
import hr.fer.zemris.ecf.lab.view.fer.zemris.ecf.engine.log.Generation;
import hr.fer.zemris.ecf.lab.view.fer.zemris.ecf.engine.log.Population;

import java.util.ArrayList;

/**
 * This class has only one static meted that is used to parse {@link Generation} from one {@link hr.fer.zemris.ecf.lab.view.fer.zemris.ecf.engine.log.LogFile}.
 * @version 1.0
 *
 */
